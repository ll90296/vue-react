...
class Play extends React.Component {
    ...
    componentDidMount() {
        ...
        // console.log(this.rotated.current);
        function rotate() {
            setInterval(function () {
                let rotated = document.querySelector('.blackCri')
                // let rotated = this.rotated.current
                rotateVal += 1
                rotated.style.transform = 'rotate(' + rotateVal + 'deg)'
                rotated.style.transition = '0.1s linear'
            }, 100)
        }
    ...
    render() {
        ...
        return (
            <div className="play">
                <div className="top">
                    <div className="blackCri" ref={this.rotated} onClick={this.toPlay.bind(this)}>
                        <div>
